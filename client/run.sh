...
echo リソースをダウンロード中...
curl -OsSf https://github.com/kyazuki/NaangisKhan-Modpack-Installer/releases/download/test/client.zip 2>/dev/null
if [ $? -ne 0 ]; then
...
curl -OsSf https://github.com/kyazuki/Minecraft-Modpack-Installer/releases/download/v1.0.0/minecraft-modpack-installer-1.0.0.jar 2>/dev/null
if [ $? -ne 0 ]; then
