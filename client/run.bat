...
echo リソースをダウンロード中...
bitsadmin /transfer resources /priority FOREGROUND https://github.com/kyazuki/NaangisKhan-Modpack-Installer/releases/download/v1.0.12/client.zip "%CD%\client.zip" > nul
if errorlevel 1 (
