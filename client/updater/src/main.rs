...
fn updater(version: Option<Version>) -> Result<(), Box<dyn error::Error>> {
    ...
    if is_old_version(&version, &"1.1.11".try_into()?) {
        ...
        println!("v1.1.11アップデートの適用を開始します...");
        ...
        remove_file_if_exist("mods/create_enchantment_industry-1.20.1-for-create-0.5.1.f-1.2.7.h.jar")?;
        download_curseforge_file(
