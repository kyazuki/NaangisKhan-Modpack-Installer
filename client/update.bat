...
bitsadmin /transfer installer /priority FOREGROUND https://github.com/kyazuki/NaangisKhan-Modpack-Installer/releases/download/v1.0.18/NaangisKhan.zip "%CD%\resourcepacks\NaangisKhan.zip" > nul
